...
R package **mrmagpie**, version **1.10.2.9003**
...
MAgPIE Input Data Library_. doi: 10.5281/zenodo.4319612 (URL: https://doi.org/10.5281/zenodo.4319612), R package version 1.10.2.9003,
...
@Manual{,
  ...
  year = {2021},
  note = {R package version 1.10.2.9003},
