...
R package **mrmagpie**, version **0.46.2.9002**
...
Karstens K, Dietrich J, Chen D, Windisch M, Alves M, Beier F, v. Jeetze P, Mishra A, Humpenoeder F (2020). _mrmagpie: madrat based MAgPIE
Input Data Library_. R package version 0.26.1.
