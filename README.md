...
R package **mrmagpie**, version **1.16.0.9002**
...
Karstens K, Dietrich J, Chen D, Windisch M, Alves M, Beier F, v. Jeetze P, Mishra A, Humpenoeder F (2021). _mrmagpie: madrat based MAgPIE Input Data Library_. doi: 10.5281/zenodo.4319612 (URL: https://doi.org/10.5281/zenodo.4319612), R package version 1.16.0.9002, <URL: https://github.com/pik-piam/mrmagpie>.
...
@Manual{,
  ...
  year = {2021},
  note = {R package version 1.16.0.9002},
