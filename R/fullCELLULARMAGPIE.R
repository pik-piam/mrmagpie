...
fullCELLULARMAGPIE <- function(rev=0.1, dev="", ctype="c200", climatetype="MRI-ESM2-0:ssp370",
  ...
  calcOutput("LanduseInitialisation", aggregate=FALSE, cellular=TRUE, fao_corr=TRUE, input_magpie=TRUE, selectyears=mag_years_past_long, round=6, country_level=TRUE, file=paste0("avl_land_t_iso.cs3"))
  ...
  calcOutput("AvlCropland", marginal_land="magpie", cell_upper_bound = 0.9, aggregate=FALSE, country_level=TRUE, round=6, file=paste0("avl_cropland_iso.cs3"))
