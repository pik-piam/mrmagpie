...
fullCELLULARMAGPIE <- function(rev = 0.1, dev = "", ctype = "c200", climatetype = "MRI-ESM2-0:ssp370",
  ...
  if (grepl("MPPA", dev)) {
    calcOutput("GrasslandsYields", lsu_levels = c(seq(0, 2.2, 0.2), 2.5), past_mngmt = "me2", lpjml = "lpjml5p2_pasture", climatetype = "MRI_ESM2_0", scenario = "ssp126_co2_Nreturn0p5_limN", file = paste0("f14_grassl_yld_", ctype, ".mz"), years = mag_years, aggregate = "cluster")
    calcOutput("GrasslandsYields", lsu_levels = c(seq(0, 2.2, 0.2), 2.5), past_mngmt = "me2", lpjml = "lpjml5p2_pasture", climatetype = "MRI_ESM2_0", scenario = "ssp126_co2_Nreturn0p5_limN", file = paste0("f14_grassl_yld.mz"), years = mag_years, aggregate = F)
    ...
    calcOutput("GrassSoilEmu", subtype = "ISIMIP3b:MRI_ESM2_0:ssp126:1965_2100", model = "9eaf9b", mfile = "weights", aggregate = F)
    calcOutput("GrassSoilEmu", subtype = "ISIMIP3b:MRI_ESM2_0:ssp126:1965_2100", model = "9eaf9b", mfile = "mean_col", aggregate = F)
    calcOutput("GrassSoilEmu", subtype = "ISIMIP3b:MRI_ESM2_0:ssp126:1965_2100", model = "9eaf9b", mfile = "stddevs_col", aggregate = F)
    calcOutput("GrassSoilEmu", subtype = "ISIMIP3b:MRI_ESM2_0:ssp126:1965_2100", model = "9eaf9b", mfile = "mean_lab", aggregate = F)
    calcOutput("GrassSoilEmu", subtype = "ISIMIP3b:MRI_ESM2_0:ssp126:1965_2100", model = "9eaf9b", mfile = "stddevs_lab", aggregate = F)
    calcOutput("GrassSoilEmu", subtype = "ISIMIP3b:MRI_ESM2_0:ssp126:1965_2100", model = "9eaf9b", mfile = "inputs", aggregate = F)
    ...
    calcOutput("CollectSoilCarbonLSU", lsu_levels = c(seq(0, 2, 0.2), 2.5), lpjml = "lpjml5p2_pasture", climatetype = "MRI_ESM2_0", scenario = "ssp126_co2_Nreturn0p5_limN", sar = 1, aggregate = F, file = paste0("soilc_stocks_gramnt.mz"), years = lpj_years)
    calcOutput("CollectSoilCarbonPastr", past_mngmt = "me2", lpjml = "lpjml5p2_pasture", climatetype = "MRI_ESM2_0", aggregate = F, scenario = "ssp126_co2_Nreturn0p5_limN", sar = 1, file = paste0("soilc_stocks_pastr.mz"), years = lpj_years)
