...
fullCELLULARMAGPIE <- function(rev=0.1, dev="", ctype="c200", climatetype="HadGEM2_ES:rcp2p6:co2", lpjml=c(natveg="LPJmL4", crop="LPJmL5GGCMI", cgrazing="LPJmL_cgrazing", mowing= "LPJmL_mowing"), clusterweight=NULL) {
  ...
  #10 land
  calcOutput("LanduseInitialisation", aggregate=FALSE, cellular=TRUE, cells="magpiecell", land="fao", input_magpie=TRUE, selectyears=mag_years_past_long, round=6, file="avl_land_t_0.5.mz")
  ...
  calcOutput("WaterUseNonAg", source="WATERGAP2020", years=lpj_years, seasonality="grper", waterusetype="withdrawal", finalcells="magpiecell", aggregate="cluster", file=paste0("watdem_nonagr_ww_grper_", ctype, ".mz"))
  calcOutput("WaterUseNonAg", source="WATERGAP2020", years=lpj_years, seasonality="grper", waterusetype="consumption", finalcells="magpiecell", aggregate="cluster", file=paste0("watdem_nonagr_wc_grper_", ctype, ".mz"))
