...
fullCELLULARMAGPIE <- function(rev=0.1, dev="", ctype="c200", climatetype="GFDL-ESM4:ssp370",
  ...
  if(grepl("pasturetest",dev)){
    ...
    calcOutput("PastYields_new", lsu_levels = c(seq(0, 2, 0.2), 2.5), mowing_events = "me2", lpjml= "lpjml5.2_pasture", climatetype = "IPSL_CM6A_LR", scenario = "ssp126_co2_limN", file=paste0("lpj_past_yields_new_", ctype, ".mz"), years = mag_years)
