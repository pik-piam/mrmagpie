...
fullCELLULARMAGPIE <- function(rev = 0.1, dev = "", ctype = "c200", climatetype = "MRI-ESM2-0:ssp370",
  ...
  if (grepl("MPPA", dev)) {
    ...
    calcOutput("GrassSoilEmu", subtype = "ISIMIP3b:IPSL_CM6A_LR:ssp126:1965_2100", model = "9eaf9b", mfile = "weights", aggregate = F)
    calcOutput("GrassSoilEmu", subtype = "ISIMIP3b:IPSL_CM6A_LR:ssp126:1965_2100", model = "9eaf9b", mfile = "mean_col", aggregate = F)
    calcOutput("GrassSoilEmu", subtype = "ISIMIP3b:IPSL_CM6A_LR:ssp126:1965_2100", model = "9eaf9b", mfile = "stddevs_col", aggregate = F)
    calcOutput("GrassSoilEmu", subtype = "ISIMIP3b:IPSL_CM6A_LR:ssp126:1965_2100", model = "9eaf9b", mfile = "mean_lab", aggregate = F)
    calcOutput("GrassSoilEmu", subtype = "ISIMIP3b:IPSL_CM6A_LR:ssp126:1965_2100", model = "9eaf9b", mfile = "stddevs_lab", aggregate = F)
    calcOutput("GrassSoilEmu", subtype = "ISIMIP3b:IPSL_CM6A_LR:ssp126:1965_2100", model = "9eaf9b", mfile = "inputs", aggregate = F)
  ...
  #
  #   if(grepl("nN",dev)){
  #     calcOutput("GrasslandsYields", lsu_levels = c(seq(0, 2.2, 0.2), 2.5), past_mngmt = "me2", lpjml= "lpjml5p2_pasture", climatetype = "IPSL_CM6A_LR", scenario = "ssp126_co2_noN", file=paste0("lpj_past_yields_new_", ctype, ".mz"), years = mag_years,  aggregate = "cluster")
  ...
  #     calcOutput("CollectSoilCarbonPastr", past_mngmt = "me2", lpjml = "lpjml5p2_pasture", climatetype = "IPSL_CM6A_LR", aggregate ="cluster", scenario = "ssp126_co2_limN", sar = 1,  years = mag_years, file = paste0("soilc_stocks_pastr_", ctype, ".mz"))
  #
  #   } else {
  #     calcOutput("GrasslandsYields", lsu_levels = c(seq(0, 2.2, 0.2), 2.5), past_mngmt = "me2", lpjml = "lpjml5p2_pasture", climatetype = "IPSL_CM6A_LR", scenario = "ssp126_co2_Nreturn0p5_limN", file = paste0("lpj_past_yields_new_", ctype, ".mz"), years = mag_years, aggregate = "cluster")
  ...
  #     calcOutput("CollectSoilCarbonPastr", past_mngmt = "me2", lpjml = "lpjml5p2_pasture", climatetype = "IPSL_CM6A_LR", aggregate ="cluster", scenario = "ssp126_co2_Nreturn0p5_limN", sar = 1,  years = mag_years, file = paste0("soilc_stocks_pastr_", ctype, ".mz"))
  #   }
  # }
