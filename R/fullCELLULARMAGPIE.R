...
fullCELLULARMAGPIE <- function(rev = 0.1, dev = "", ctype = "c200", climatetype = "MRI-ESM2-0:ssp370",
  ...
  calcOutput("PastureSuit",  aggregate = "cluster", subtype = "ISIMIP3b:IPSL-CM6A-LR:1850-2100", file = paste0("f31_past_suitability_", ctype, ".mz"), years = mag_years)
  calcOutput("GrassPastureShare", aggregate = "cluster", file = paste0("f31_past_share_", ctype, ".mz"))
